...
[![Version](https://img.shields.io/badge/version-1.1.5-blue.svg)](https://github.com/voz261/crownx-hdmmmb-helpdesk-tools)
...
| Nút | Chức năng | Mô tả |
|:---|:---|:---|
| **Reply (+clipboard)** | Trả lời ticket | Lấy nội dung từ clipboard và dán vào khung reply |
...
**tuanna3** - CrownX IT Helpdesk khu vực miền Bắc
